...
|---|---|---|---|---|
| `ct-accordion` | Accordion | 4 | item | 4 |
...
| `ct-faq` | FAQ | 3 | item | 5 |
| `ct-feature-blocks` | Feature blocks | 4 | feature | 3 |
...
| `ct-pricing-table` | Pricing table | 4 | plan | 3 |
| `ct-product-buy` | Product buy | 16 | tier | 3 |
| `ct-product-info` | Product information | 3 | spec | 4 |
...
| `ct-shipping-estimate` | Shipping estimate | 9 | - | 0 |
| `ct-size-chart` | Size guide | 10 | row | 4 |
| `ct-stats` | Stats band | 4 | stat | 4 |
| `ct-steps` | How it works | 4 | step | 3 |
| `ct-sticky-atc` | Sticky add to cart | 1 | - | 0 |
| `ct-styleguide` | CT Styleguide (dev) | 7 | - | 0 |
| `ct-tabs` | Content tabs | 4 | tab | 3 |
| `ct-timeline` | Timeline | 4 | milestone | 4 |
| `ct-trust-bar` | Trust bar | 5 | benefit, payment, text, divider | 4 |
